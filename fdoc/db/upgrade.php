...
function xmldb_fdoc_upgrade($oldversion=0) {
...
/// for demonstrative purposes and to show how the fdoc
/// iself has been upgraded.

/// For each upgrade block, the file fdoc/version.php
...
/// First example, some fields were added to the module on 20070400
    ...
    /// Define field course to be added to fdoc
        $table = new XMLDBTable('fdoc');
        $field = new XMLDBField('course');
        $field->setAttributes(XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, null, '0', 'id');
    /// Launch add field course
        $result = $result && add_field($table, $field);

    /// Define field intro to be added to fdoc
        $table = new XMLDBTable('fdoc');
    ...
    /// Define field introformat to be added to fdoc
        $table = new XMLDBTable('fdoc');
...
/// "01" in the last two digits of the version
    if ($result && $oldversion < 2012032701) {

    /// Define field timecreated to be added to fdoc
        $table = new XMLDBTable('fdoc');
    ...
    /// Define field timemodified to be added to fdoc
        $table = new XMLDBTable('fdoc');
    ...
    /// Define index course (not unique) to be added to fdoc
        $table = new XMLDBTable('fdoc');
