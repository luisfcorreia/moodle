...
function xmldb_sumarios_upgrade($oldversion) {
    ...
    if ($oldversion < 2007040100) {
        ...
        upgrade_mod_savepoint(true, 2007040100, 'sumarios');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to sumarios
        $table = new xmldb_table('sumarios');
        ...
        // Define field timemodified to be added to sumarios
        $table = new xmldb_table('sumarios');
        ...
        // Define index course (not unique) to be added to sumarios
        $table = new xmldb_table('sumarios');
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'sumarios');
    }
