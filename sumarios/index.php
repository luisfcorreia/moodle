...
/// Replace sumarios with the name of your module and remove this line
...
if (! $sumarioss = get_all_instances_in_course('sumarios', $course)) {
    notice(get_string('nosumarioss', 'sumarios'), new moodle_url('/course/view.php', array('id' => $course->id)));
}
