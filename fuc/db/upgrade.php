...
/**
 * This file keeps track of upgrades to the fuc module
 *
...
/**
 * Execute fuc upgrade from the given old version
 *
...
function xmldb_fuc_upgrade($oldversion) {
    ...
    if ($oldversion < 2007040100) {
        ...
        upgrade_mod_savepoint(true, 2007040100, 'fuc');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        upgrade_mod_savepoint(true, 2007040101, 'fuc');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'fuc');
    }
